...
Tag pushes such as `v0.1.2` publish release assets named:

```text
joycode_0.1.2_linux_amd64.zip
joycode_0.1.2_linux_arm64.zip
joycode_0.1.2_freebsd_amd64.zip
joycode_0.1.2_darwin_amd64.zip
joycode_0.1.2_darwin_arm64.zip
joycode_0.1.2_windows_amd64.zip
joycode_0.1.2_windows_arm64.zip
checksums.txt
```
