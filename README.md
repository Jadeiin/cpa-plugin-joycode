...
Tag pushes such as `v0.2.3` publish release assets named:

```text
joycode_0.2.3_linux_amd64.zip
joycode_0.2.3_linux_arm64.zip
joycode_0.2.3_freebsd_amd64.zip
joycode_0.2.3_darwin_amd64.zip
joycode_0.2.3_darwin_arm64.zip
joycode_0.2.3_windows_amd64.zip
joycode_0.2.3_windows_arm64.zip
checksums.txt
```
