...
Tag pushes such as `v0.1.1` publish release assets named:

```text
joycode_0.1.1_linux_amd64.zip
joycode_0.1.1_linux_arm64.zip
joycode_0.1.1_freebsd_amd64.zip
joycode_0.1.1_darwin_amd64.zip
joycode_0.1.1_darwin_arm64.zip
joycode_0.1.1_windows_amd64.zip
joycode_0.1.1_windows_arm64.zip
checksums.txt
```
